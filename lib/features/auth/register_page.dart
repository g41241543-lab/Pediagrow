...
class _RegisterPageState extends State<RegisterPage> {
  ...
  /// Memulai alur Google Sign-In untuk pendaftaran menggunakan [GoogleAuthService].
    ...
    try {
      ...
      if (result.isCancelled) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Daftar dengan Google dibatalkan.',
      ...
      if (!result.isSuccess) {
        showGoogleAuthErrorDialog(
          context,
          errorMessage: result.errorMessage ?? 'Gagal daftar dengan Google.',
      ...
      // Berhasil — tampilkan pesan sambutan lalu navigasi ke Beranda
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Selamat datang di PediaGrow, ${account.displayName ?? account.email}!',
            style: GoogleFonts.lato(color: Colors.white),
          ),
      ...
      showGoogleAuthErrorDialog(
        context,
        errorMessage: 'Gagal daftar dengan Google: $e',
      );
    } finally {
